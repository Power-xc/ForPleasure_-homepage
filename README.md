...
| `skills/개발/운영-프로토콜.md` | 모든 규칙의 근간 (아키텍처/품질/보안/Git) |
| `skills/개발/기능명세-양식.md` | 새 기능 시작 시 복사해 쓰는 명세서 양식 |
| `scripts/audit-skills.mjs` | 스킬 정합성 자동 감사 (`npm run skills:audit`) |

## 시작하기

새 기능은 코드부터 짜지 않는다. `skills/개발/기능명세-양식.md`를 복사해 **명세서.md** 작성부터 시작한다.
