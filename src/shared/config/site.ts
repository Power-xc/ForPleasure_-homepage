...
export const HOW_IT_WORKS = [
  {
    ...
    image: "/images/temp-approval.png",
  },
  {
    step: "STEP 2",
    title: "스토리 작성",
    body: "자기소개와 가치관을 스토리로 남기면 심사를 거칩니다.",
    image: "/images/story-input.png",
  },
  {
    step: "STEP 3",
    title: "선택과 매칭",
    body: "여성이 먼저 프로필을 보고 선택해 매칭이 시작됩니다.",
    image: "/images/matching-waiting.png",
  },
  {
    step: "STEP 4",
    title: "일정·장소 확정",
    body: "앱 안에서 만날 날짜와 장소까지 함께 정합니다.",
    image: "/images/schedule-propose.png",
  },
  {
    step: "STEP 5",
    title: "약속, 그리고 만남",
...
export const EVENTS = [
  {
    ...
    image: "/images/event-invite-friends.png",
  },
  {
    title: "데일리 보상",
